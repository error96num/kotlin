    ...
    fun action() {
        ...
        if (directSwiftPMDependencies.isNotEmpty() || transitiveSwiftPMDependencies.isNotEmpty()) {
            ...
            val message = buildString {
                ...
                appendLine("${PROJECT_PATH_ENV}='${xcodeProjectPath}' '${gradlewPath}' -p '${rootProjectDir.get()}' '${gradleTaskPath(gradleProjectPath.get(), IntegrateEmbedAndSignIntoXcodeProject.TASK_NAME)}' '${gradleTaskPath(gradleProjectPath.get(), IntegrateLinkagePackageIntoXcodeProject.TASK_NAME)}'")
