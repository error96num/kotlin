...
internal abstract class GenerateSyntheticLinkageImportProject : DefaultTask(), UsesBuildFusService {
    ...
    private fun generatePackageManifest(
        ...
        manifest.also {
            ...
            SwiftImportManifestGenerator.generateManifest(
                ...
                headerComments = GENERATED_MANIFEST_HEADER,
            )
        )
    ...
    companion object {
        ...
        /**
         * KT-86647: Explanatory header emitted into every generated Package.swift.
         *
         * Some of the generated packages are intended to be stored under version control
         * (the linkage package referenced by the Xcode project and the umbrella package
         * under `.swiftpm-locks`), so the header explains where the contents come from
         * and how to regenerate them instead of editing them manually.
         *
         * Note: this header is part of the generated manifest contents, so it must stay
         * identical across all tasks that may regenerate the same package root. Otherwise
         * regeneration would be reported as a non-idempotent change.
         */
        val GENERATED_MANIFEST_HEADER: List<String> = listOf(
            "",
            "This package is generated by the Kotlin Gradle plugin (SwiftPM import).",
            "",
            "DO NOT EDIT THIS MANIFEST AND DO NOT ADD SOURCES TO THIS PACKAGE MANUALLY.",
            "The package is not intended for user code: the Kotlin Gradle plugin will",
            "regenerate it, overwriting any manual change. This note applies to humans",
            "and AI agents alike - treat the whole package as build output.",
            "",
            "The contents of this manifest are derived from:",
            " * the `swiftPMDependencies {}` block in the Kotlin Gradle build scripts",
            " * SwiftPM dependencies inherited from dependency Kotlin modules",
            "",
            "To change this package, edit the `swiftPMDependencies {}` block and rerun",
            "the Gradle task that generated it (for example `integrateLinkagePackage`",
            "for the package referenced by the Xcode project). If this package is stored",
            "under version control, commit the regenerated contents as-is.",
            "",
        )
    }
}
