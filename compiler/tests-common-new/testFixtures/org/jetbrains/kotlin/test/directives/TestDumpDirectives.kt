...
fun File.toClassifiedDumpFile(extension: String, directives: RegisteredDirectives): File {
    val classifier = directives[TestDumpDirectives.DUMP_CLASSIFIER].firstOrNull() ?: ""
...
fun Assertions.assertEqualsToDump(
    ...
    if (actualDump == null) {
        assertFileDoesntExist(classifiedDumpFile) { "Dump file detected but nothing to dump." }
        return
    }
